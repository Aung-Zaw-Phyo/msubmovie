            ...
            <div className='container grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4'>
                ...
                <div className='lg:col-span-1 flex lg:justify-end items-center'>
                    <div className='flex flex-col sm:flex-row gap-3 sm:gap-0 justify-center items-center w-full'>
                        ...
                        />
                        <button className="inline-flex h-14 w-full sm:!w-[30%] justify-center items-center py-3 px-4 sm:px-6 tracking-wide rounded-tr-lg rounded-br-lg rounded-tl-lg rounded-bl-lg sm:rounded-tl-none sm:rounded-bl-none uppercase bg-blue-600 hover:bg-blue-500 border-none text-white text-lg duration-300">
                        {t("send")}
                        </button>
                    </div>
                </div>
