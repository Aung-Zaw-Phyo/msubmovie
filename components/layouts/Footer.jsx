...
const Footer = async() => {
  ...
  return (
    <div>
        <div className='bg-[#E31B1E] bg-cover bg-center object-cover bg-no-repeat py-12' style={{ backgroundImage: "url('https://base-tailwind.preview.uideck.com/images/shape-16.svg')" }}>
