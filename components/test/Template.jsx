  ...
  return (
        ...
        { /* Header Area wrapper Starts */ }
            ...
            {/* <div className="navigation fixed top-0 left-0 w-full z-30 duration-300">
                ...
                <nav className=" navbar py-2 navbar-expand-lg flex justify-between items-center relative duration-300     ">
                    ...
                    <span className=" toggler-icon block bg-gray-700 relative duration-300 h-[2px] w-[30px] my-[6px] ">
                    </span>
                    <span className=" toggler-icon block bg-gray-700 relative duration-300 h-[2px] w-[30px] my-[6px] ">
                    </span>
                    <span className=" toggler-icon block bg-gray-700 relative duration-300 h-[2px] w-[30px] my-[6px] ">
                    ...
                    <div className=" collapse navbar-collapse hidden lg:block duration-300 shadow absolute top-full left-0 mt-full bg-white z-20 px-5 py-3 w-full lg:static lg:bg-transparent lg:shadow-none " id="navbarSupportedContent">
                    <ul className="navbar-nav mr-auto justify-center items-center lg:flex">
                        <li className="nav-item">
                        <a className="page-scroll nav-link active" href="#hero-area">Home</a>
                        </li>
                        <li className="nav-item">
                        <a className="page-scroll nav-link" href="#services">Services</a>
                        </li>
                        <li className="nav-item">
                        <a className="page-scroll nav-link" href="#feature">feature</a>
                        </li>
                        <li className="nav-item">
                        <a className="page-scroll nav-link" href="#team">Team</a>
                        </li>
                        <li className="nav-item">
                    ...
                    <a className=" text-blue-600 border border-blue-600 px-10 py-3 rounded-full duration-300 hover:bg-blue-600 hover:text-white " href="#feature">
                        FAQ</a>
                    </div>
                </nav>
                </div>
        ...
        <div className="flex justify-between">
          <div className="w-full text-center">
            <h2 className="text-4xl font-bold leading-snug text-gray-700 mb-10">
              You are Using Free Lite Version of <br className="hidden lg:block" />
              Shine Template
            </h2>
            <div className="text-center mb-10">
              <a href="#" rel="nofollow" className=" text-white bg-blue-600 px-10 py-3 rounded-full duration-300 hover:bg-blue-500 ">
                Purchase Now</a>
            </div>
      ...
      <div className="container px-4">
        ...
        <div className="flex flex-wrap justify-center">
          ...
          <div className="max-w-sm sm:w-1/2 md:w-1/2 lg:w-1/3">
            <div className=" m-3 text-center bg-white shadow duration-300 group hover:shadow-lg ">
              <div className="team-img relative">
                <img className="img-fluid" src="assets/img/team/img1.jpg" alt="" />
                <div className="   w-full   h-full   flex   items-center   justify-center   absolute   top-0   left-0   bg-white bg-opacity-60   duration-300   opacity-0   group-hover:opacity-100 ">
        ...
        <div className="flex flex-wrap justify-center items-center">
          <div className="w-1/2 md:w-1/4 lg:w-1/4">
            <div className="m-3 p-4 group text-center">
              <img className=" mx-auto opacity-60 group-hover:opacity-100 filter grayscale group-hover:filter-none group-hover:grayscale-[none] " src="assets/img/clients/graygrids.svg" alt="" />
            </div>
          </div>
          <div className="w-1/2 md:w-1/4 lg:w-1/4">
            <div className="m-3 p-4 group text-center">
              <img className=" mx-auto opacity-60 group-hover:opacity-100 filter grayscale group-hover:filter-none group-hover:grayscale-[none] " src="assets/img/clients/uideck.svg" alt="" />
            </div>
          </div>
          <div className="w-1/2 md:w-1/4 lg:w-1/4">
            <div className="m-3 p-4 group text-center">
              <img className=" mx-auto opacity-60 group-hover:opacity-100 filter grayscale group-hover:filter-none group-hover:grayscale-[none] " src="assets/img/clients/ayroui.svg" alt="" />
            </div>
          </div>
          <div className="w-1/2 md:w-1/4 lg:w-1/4">
            <div className="m-3 p-4 group text-center">
              <img className=" mx-auto opacity-60 group-hover:opacity-100 filter grayscale group-hover:filter-none group-hover:grayscale-[none] " src="assets/img/clients/lineicons.svg" alt="" />
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="container px-4">
        <div className="flex flex-wrap justify-center md:justify-start">
          ...
          <div className="w-3/4 sm:w-2/3 md:w-1/2 lg:w-1/3">
            <div className=" m-3 text-center py-10 px-8 shadow rounded duration-300 hover:shadow-lg hover:bg-blue-100 wow fadeInLeft ">
              <div className="mb-3">
                <h3 className="text-blue-600 font-bold uppercase text-sm">Basic</h3>
              </div>
              <div className="mb-5">
              ...
              <a href="#" className=" text-white bg-blue-600 px-10 py-3 rounded-full duration-300 hover:bg-blue-500 ">Get It</a>
            </div>
          </div>
          { /* single pricing table ends */ }
          { /* single pricing table starts */ }
          <div className="w-3/4 sm:w-2/3 md:w-1/2 lg:w-1/3">
            <div className=" m-3 text-center py-10 px-8 shadow rounded duration-300 hover:shadow-lg hover:bg-blue-100 bg-blue-100 wow fadeInLeft ">
              <div className="mb-3">
              ...
              <ul className="mb-16">
                ...
                <li className="text-gray-500 leading-9">Real-time collabration</li>
              </ul>
              <a href="#" className=" text-white bg-blue-600 px-10 py-3 rounded-full duration-300 hover:bg-blue-500 ">Get It</a>
            </div>
          </div>
          ...
          { /* single pricing table starts */ }
          <div className="w-3/4 sm:w-2/3 md:w-1/2 lg:w-1/3">
            <div className=" m-3 text-center py-10 px-8 shadow rounded duration-300 hover:shadow-lg hover:bg-blue-100 ">
              <div className="mb-3">
                <h3 className="text-blue-600 font-bold uppercase text-sm">
                  EXPERT
                </h3>
              ...
              <ul className="mb-16">
                ...
                <li className="text-gray-500 leading-9">Unlimited collabrators</li>
          ...
          <div className="w-full sm:w-3/4 md:w-2/3 lg:w-1/2">
            ...
            <form htmlFor="">
              <div className="wow fadeInDown">
                ...
                <button className="   border-0   bg-blue-600   text-white   rounded-full   w-12   h-12   duration-300   hover:opacity-75 " type="submit">
                ...
                <div className="flex flex-wrap">
                  ...
                  <div className="w-full">
                    <div className="submit-button mx-3">
                      <button className="         text-white         bg-blue-600         px-10         py-3         rounded-full         duration-300         hover:bg-blue-500       " id="form-submit" type="submit">
                        Send Message
                      </button>
                    </div>
                  </div>
            ...
            <div className="ml-3 md:ml-12 wow fadeIn">
              ...
              <div>
                <div className="flex flex-wrap mb-6 items-center">
                  <div className="     w-10     h-10     flex     items-center     justify-center     bg-blue-600     text-xl text-white     rounded-full   ">
    ...
    <section id="google-map-area">
      <div className="mx-6 mb-6">
        <div className="flex">
          <div className="w-full">
            <object style={{ border: "0", height: 450, width: "100%" }} data="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3102.7887109309127!2d-77.44196278417968!3d38.95165507956235!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMzjCsDU3JzA2LjAiTiA3N8KwMjYnMjMuMiJX!5e0!3m2!1sen!2sbd!4v1545420879707" />
          </div>
        </div>
      </div>
    </section>
        ...
        <div className="flex flex-wrap">
          ...
          <div className="w-full sm:w-1/2 md:w-1/2 lg:w-1/4">
            <div className="mx-3 mb-8">
              ...
              <ul>
                <li>
                  <a href="#" className="     leading-9     text-gray-100     duration-300     hover:text-blue-500   ">
                    Press Releases
                  </a>
                </li>
                <li>
                  <a href="#" className="     leading-9     text-gray-100     duration-300     hover:text-blue-500   ">Mission</a>
                </li>
                <li>
                  <a href="#" className="     leading-9     text-gray-100     duration-300     hover:text-blue-500   ">Strategy</a>
                </li>
              </ul>
            </div>
          </div>
          <div className="w-full sm:w-1/2 md:w-1/2 lg:w-1/4">
            <div className="mx-3 mb-8">
              ...
              <ul>
                ...
                <li>
                  <a href="#" className="     leading-9     text-gray-100     duration-300     hover:text-blue-500   ">Team</a>
                </li>
                <li>
                  <a href="#" className="     leading-9     text-gray-100     duration-300     hover:text-blue-500   ">Clients</a>
                </li>
              </ul>
            </div>
          </div>
          <div className="w-full sm:w-1/2 md:w-1/2 lg:w-1/4">
            <div className="mx-3 mb-8">
              ...
              <ul className="social-icons flex justify-start">
                <li className="mr-4">
                  <a href="#" className="     flex     justify-center     items-center     w-8     h-8     bg-white     rounded-full     text-sm text-gray-700     duration-300     hover:text-white hover:bg-indigo-500   ">
                    <i className="lni lni-facebook-filled" aria-hidden="true"> </i>
                  </a>
                </li>
                <li className="mr-4">
                  <a href="#" className="     flex     justify-center     items-center     w-8     h-8     bg-white     rounded-full     text-sm text-gray-700     duration-300     hover:text-white hover:bg-blue-400   ">
                    <i className="lni lni-twitter-filled" aria-hidden="true"> </i>
                  </a>
                </li>
                <li className="mr-4">
                  <a href="#" className="     flex     justify-center     items-center     w-8     h-8     bg-white     rounded-full     text-sm text-gray-700     duration-300     hover:text-white hover:bg-red-500   ">
                    <i className="lni lni-instagram-filled" aria-hidden="true"> </i>
                  </a>
                </li>
                <li className="mr-4">
                  <a href="#" className="     flex     justify-center     items-center     w-8     h-8     bg-white     rounded-full     text-sm text-gray-700     duration-300     hover:text-white hover:bg-indigo-600   ">
        ...
        <div className="flex flex-wrap">
          <div className="w-full text-center">
            <p className="text-white">
              ...
              <a className="text-white duration-300 hover:text-blue-600" href="https://tailwindtemplates.co" rel="nofollow">
                TailwindTemplates
              </a>
              and
