        ...
        <div className="flex flex-col md:flex-row justify-center lg:flex-wrap gap-3 mt-auto">
            ...
            <div className='w-full'>
                <button 
                    ...
                    data-dropdown-toggle="mxad-dropdown" 
                    className="
                ...
                <div id="mxad-dropdown" className="z-10 hidden bg-red-500 divide-y divide-gray-100 rounded-lg shadow w-40 md:w-36 dark:bg-gray-700">
