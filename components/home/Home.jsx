...
const Home = async() => {
  ...
  return (
    ...
    >
        ...
        <h1 className='mb-3 text-4xl font-bold logo-text'>MSub YoteShin</h1>
        <p className='text-white text-center text-lg leading-8 mb-4'>
            {t('download_setence_1')} <br />
            {t('download_setence_2')}
        </p>
        <a href="#download" className="inline-flex py-3 px-6 text-sm tracking-wide rounded-lg uppercase bg-[#E31B1E] border-[#E31B1E] border hover:bg-red-500 hover:border-red-500 text-white duration-300">
            {t('download_now')}
        </a>
    </div>
  )
